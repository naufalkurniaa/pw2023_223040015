  ...
  <div class="row">
    ...
    <div class="col-md-7">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card mb-3">
            <a href="cornflakes.php"><img src="img/gambar10.jpg" class="card-img-top" alt="foto alex"></a>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-3">
            <a href="ketupat.php"><img src="img/gambar11.jpg" class="card-img-top" alt="tubuh kelebihan seng"></a>
            <div class="card-body">
