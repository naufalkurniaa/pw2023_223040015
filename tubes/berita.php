...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4">
          <div class="card mb-3">
            <a href="headline.php"><img src="img/gambar1.jpg" class="card-img-top" alt="tni"></a>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-3">
            <a href="surat.php"><img src="img/gambar7.jpg" class="card-img-top" alt="foto alex"></a>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card mb-3">
            <a href="banteng.php"><img src="img/gambar5.jpg" class="card-img-top" alt="foto alex"></a>
            <div class="card-body">
